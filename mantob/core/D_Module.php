...
require_once FCPATH.'mantob/core/D_Common.php';
...
class D_Module extends D_Common {
	...
	protected function _index() {
        ...
        $name = is_file(FCPATH.$this->dir.$path.'index.html') ? 'index.html' : (is_file(FCPATH.'mantob'.$path.'module.html') ? 'module.html' : 'index.html');
	...
	protected function _search($call = '') {
        ...
        if (is_file(FCPATH.$this->dir.'models/Search_model.php')) {
            ...
            require_once FCPATH.'mantob/models/Search_model.php';
        }
