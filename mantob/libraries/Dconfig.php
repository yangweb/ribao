...
class Dconfig {
	...
	public function file($file) {
		...
		'/**'.PHP_EOL.
		' * Mantob Website Management System'.PHP_EOL.
		' * '.PHP_EOL.
		' * @since			version '.MAN_VERSION.PHP_EOL.
		' * @author			mantob <kefu@mantob.com>'.PHP_EOL.
		' * @license     	http://www.mantob.com/license'.PHP_EOL.
		' * @copyright		Copyright (c) 2013 - 9999, mantob.Com, Inc.'.PHP_EOL.
		' */'.PHP_EOL.PHP_EOL
		;
		return $this;
	}
