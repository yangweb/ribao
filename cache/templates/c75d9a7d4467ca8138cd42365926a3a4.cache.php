            ...
            <div id="cnt_0" style="display:none" class="dr_hide">
              ...
              <!--   <tr>
                ...
                <tr class="dr_one">
                    <th>&nbsp;栏目描述： </th>
                    <td>
                    <textarea  type="textarea" name="data[description]" id="dr_description"  style="height:150px;" ><?php echo $data['description']; ?></textarea>
                    <div class="onShow" id="dr_description_tips">栏目的的描述文本</div>
                    </td>
                </tr>
                <tr class="dr_one">
