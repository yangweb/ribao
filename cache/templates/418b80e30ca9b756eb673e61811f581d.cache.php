...
<div class="content clearfix">
	<div class="page_url"><a href="<?php echo SITE_URL; ?>">首页</a> <span>&gt;</span> <a href="<?php echo man_member_url('home/index'); ?>">会员中心</a> <span>&gt;</span> 首页</div>
	
	<div class="aside">
		<div class="round memberinfo">
			<table width="178" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td rowspan="2" width="50"><div class="memberinfo_avatar"><a href="<?php echo man_member_url('account/avatar'); ?>"><img src="<?php echo man_avatar($uid); ?>"></a></div></td>
				<td><b>&nbsp;<?php echo $member['username']; ?></b></td>
				</tr>
			  <tr>
				<td colspan="2"><div class="man_stars"><a href="" title="<?php echo $member['levelname']; ?>"><?php echo man_show_stars($member['levelstars']); ?></a></div></td>
			  </tr>
			  <tr height="20">
				<td colspan="3" style="padding-top:8px;">
				<?php echo SITE_EXPERIENCE; ?>：<a href="<?php echo man_member_url('pay/experience'); ?>"><?php echo $member['experience']; ?></a>
				</td>
			  </tr>
			  <tr height="20">
				<td colspan="3">
				<?php echo SITE_SCORE; ?>：<a href="<?php echo man_member_url('pay/score'); ?>"><?php echo $member['score']; ?></a>
				</td>
			  </tr>
			  <tr height="20">
				<td colspan="3">
				<?php echo SITE_MONEY; ?>：<a href="<?php echo man_member_url('pay/index'); ?>"><?php echo $member['money']; ?></a>
				</td>
			  </tr>
			  <tr height="20">
				<td colspan="3">
			  ...
			  <tr height="20">
				<td colspan="3">
				审核会员：<a href="<?php echo man_url('login/resend'); ?>">重发邮件</a>
				</td>
			  </tr>
			  <?php } ?>
			</table>   
		...
		<div class="menu round">
			...
			<ul>
				<li><a href="<?php echo man_member_url('account/index'); ?>">基本资料</a></li>
				<li><a href="<?php echo man_member_url('account/password'); ?>">修改密码</a></li>
				<li><a href="<?php echo man_member_url('account/upgrade'); ?>">会员升级</a></li>
				<li><a href="<?php echo man_member_url('pm/index'); ?>">站内消息</a></li>
			</ul>
		</div>
	</div>
            ...
            <div class="main man_table">
                <table style="table-layout:fixed;">
                    ...
                    <tr>
                        ...
                        <td class="algin_l"><?php echo man_strcut($t['useragent'], 60); ?></td>
                    </tr>
                    <?php } } ?>
                    </tbody>
                </table>
