<section>
    ...
    <div class="article-archives-page">
        <div class="row">
            <div class="columns">
                <h1 class="article-archives-title">全部 <?php echo MODULE_NAME; ?></h1>
                <div class="tout-list tout-list--grid">
                    <div class="tout-list--grid__container">
                        <?php $return = $this->list_tag("action=module order=updatetime num=10 page=1"); if ($return) extract($return); $count=count($return); if (is_array($return)) { foreach ($return as $key=>$t) { ?>
