    ...
    <div class="meganav-content__description">
        <div class="row">
            <div class="small-12 columns">
               <?php echo $ci->get_cache('module-1-reports', 'category', 1, 'description'); ?>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="small-12 columns">
            <div class="meganav-section-end">
                <a href="<?php echo $ci->get_cache('module-1-reports', 'category', 1, 'url'); ?>"> <span>更多报告</span> <img src="<?php echo HOME_THEME_PATH; ?>build/imgs/link-arrow-9adfe464cd987bc5b3097b1218678552fcdd94a3e6cb7b3664bd1f75205873cc.svg" alt="Link arrow" /> </a>
            </div>
        </div>
    </div>
</div>