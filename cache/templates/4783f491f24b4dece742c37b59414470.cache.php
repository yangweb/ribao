...
<div class="pad-10">
    <div class="table-list col-tab" id="myform">
        ...
        <div class="content pad-10" style="clear:both">
			<div id="cnt_0" style="display:block" class="man_hide">
				<div>
					<div class="addnew" id="addnew">
						<span id="buttonPlaceHolder"></span>
					</div>
					<input type="button" id="btupload" value="<?php echo lang('m-135'); ?>" onClick="swfu.startUpload();" />
					<div id="nameTip" class="onShow"><?php echo man_lang('m-136', $fcount, $size/1024); ?></div>
					<div class="bk3"></div>
					<div class="lh24"><?php echo man_lang('m-138', str_replace('|', '、', $ext)); ?></div>
				</div> 	
				<div class="bk10"></div>
				...
				<li id="notused_<?php echo $t['id']; ?>">
					<div class="img-wrap">
						<a id="a_notused_<?php echo $t['id']; ?>" href="javascript:;" class="off" title="<?php echo $t['filename']; ?>">
							...
							<div onclick="man_delete_file(<?php echo $t['id']; ?>)" class="delete"></div>
...
function album_cancel(id){
	...
	if ($(obj).hasClass('on')){
		...
		if(num > <?php echo $fcount; ?>) {
		    man_tips("<?php echo man_lang('m-141', $fcount); ?>");
			return false;
		}
		$(obj).attr("class", "on");
