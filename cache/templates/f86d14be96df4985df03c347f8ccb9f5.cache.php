...
function show_category_field(catid) {
	...
	$.post(siteurl+'?s=<?php echo APP_DIR; ?>&c=category&m=field&rand='+Math.random(),{ catid:catid, data:<?php echo json_encode(man_array2string($data)); ?> }, function(data){
...
<input name="man_id" id="man_id" type="hidden" value="<?php echo $data['id']; ?>" />
<input name="man_module" id="man_module" type="hidden" value="<?php echo APP_DIR; ?>" />
<div class="subnav">
