    ...
    <div class="row nav">
        <ul class="header-container">
            ...
            <li class="header-item logo">
                <a href="/"><img class="header-wef__logo" src="<?php echo HOME_THEME_PATH; ?>build/imgs/logo-d8b23e233f85a1af9093a1946e18cff462b0ca82fcd720e2a9633270e53a0bcd.svg" alt="Logo" /></a>
            </li>
