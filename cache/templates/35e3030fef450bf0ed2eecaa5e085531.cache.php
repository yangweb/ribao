...
function man_select_all() {
    $("#man_synid").find("option").attr("selected", "selected");
}
</script>
		...
		<div class="contentList pad-10 man_table">
			<div id="cnt_0" style="display:none" class="man_hide">
                ...
                <tr>
                    ...
                    <td><?php echo man_field_input('name', 'Text', $field['name']['setting'], $data['name']); ?><div class="onShow"><?php echo lang('html-027'); ?></div></td>
                </tr>
                <tr>
                    <th><font color="red">*</font>&nbsp;<?php echo lang('140'); ?>： </th>
                    <td><?php echo man_field_input('dirname', 'Text', $field['dirname']['setting'], $data['dirname']); ?><div class="onShow"><?php echo lang('html-364'); ?></div></td>
                </tr>
                <tr>
                    <th><?php echo lang('142'); ?>： </th>
                    <td><?php echo man_field_input('title', 'Text', $field['title']['setting'], $data['title']); ?></td>
                </tr>
                <tr>
                    <th><?php echo lang('143'); ?>： </th>
                    <td><?php echo man_field_input('keywords', 'Text', $field['keywords']['setting'], $data['keywords']); ?></td>
                </tr>
                <tr>
                    <th><?php echo lang('144'); ?>： </th>
                    <td><?php echo man_field_input('description', 'Textarea', $field['description']['setting'], $data['description']); ?></td>
                </tr>
                <tr>
                    <th><?php echo lang('141'); ?>： </th>
                    <td><?php echo man_field_input('thumb', 'File', $field['thumb']['setting'], $data['thumb']); ?><div class="onShow"><?php echo lang('html-365'); ?></div></td>
                </tr>
            ...
            <div id="cnt_1" style="display:none" class="man_hide">
                ...
                <tr>
                    ...
                    <td><?php echo man_field_input('show', 'Radio', $field['show']['setting'], $data['show']); ?><div class="onShow"><?php echo lang('html-579'); ?></div></td>
                </tr>
				<tr>
                    <th><?php echo lang('html-577'); ?>： </th>
                    <td><?php echo man_field_input('getchild', 'Radio', $field['getchild']['setting'], $data['getchild']); ?><div class="onShow"><?php echo lang('html-578'); ?></div></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo man_field_input('template', 'Text', $field['template']['setting'], $data['template']); ?></td>
                </tr>
                <tr class="man_border_none">
                    <th><?php echo lang('148'); ?>： </th>
                    <td><?php echo man_field_input('urllink', 'Text', $field['urllink']['setting'], $data['urllink']); ?></td>
                </tr>
                </table>
        	</div>
            <?php if ($id) { ?>
            <div id="cnt_2" style="display:none" class="man_hide">
                ...
                <tr class="man_border_none">
                    ...
                    <td>
					<?php echo $select_syn; ?>
                    <input value="<?php echo lang('html-605'); ?>" type="button" onclick="man_select_all()" name="button" class="button" />
                    <br>
...
<div class="fixed-but text-c">
	<div class="button"><input value="<?php echo lang('html-362'); ?>" type="submit" name="submit" class="cu" onclick="$('#man_action').val('back')" style="width:100px;" /></div>
    <?php if (!$id) { ?>
    <div class="button"><input value="<?php echo lang('html-363'); ?>" type="submit" name="submit" class="cu" onclick="$('#man_action').val('continue')" style="width:100px;" /></div>
    <?php } ?>
</div>
</div>
