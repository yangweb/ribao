...
#imgPreview .on a {
    background: url("<?php echo SITE_URL; ?>mantob/statics/images/msg_bg.png") no-repeat scroll right -250px transparent;
...
<div class="subnav">
	<div class="table-list">
		...
		<tbody>
		<tr><td align="left"><?php echo lang('m-037'); ?>：<?php echo $path; ?></td></tr>
		<?php if (strlen($parent)>1) { ?>
		<tr>
		<td align="left"><img src="<?php echo SITE_URL; ?>mantob/statics/images/ext/dir.gif">&nbsp;<a href="<?php echo $purl; ?>"><?php echo lang('m-038'); ?></a></td>
		</tr>
...
function album_cancel(obj){
	...
	if ($(obj).parent().hasClass('on')){
		...
		if(num > <?php echo $fcount; ?>) {
		    alert("<?php echo dr_lang('m-141', $fcount); ?>");
			return false;
		}
